...
<script>
// FIXED: Load appointments on page load and when date changes
// This function properly connects the dateInput element to the AJAX loader
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (dateInput) {
        // Load appointments for the selected date on initial page load
        loadAppointments(dateInput.value);
        
        // Reload when user changes the date
